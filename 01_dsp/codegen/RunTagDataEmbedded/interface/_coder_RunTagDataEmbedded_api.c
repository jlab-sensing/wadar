 ...
 * File: _coder_RunTagDataEmbedded_api.c
 *
...
/* Include Files */
#include "_coder_RunTagDataEmbedded_api.h"
#include "_coder_RunTagDataEmbedded_mex.h"
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "RunTagDataEmbedded",                                 /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void RunTagDataEmbedded_atexit(void)
{
  ...
  RunTagDataEmbedded_xil_terminate();
  RunTagDataEmbedded_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_RunTagDataEmbedded_api.c
 *
 * [EOF]
 */
