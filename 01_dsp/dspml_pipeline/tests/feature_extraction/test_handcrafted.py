...
if __name__ == "__main__":
    ...
    _, lasso_features = lasso_minimize_features(feature_table=feature_table)
    _, corr_features = correlation_minimize_features(feature_table=feature_table)
    _, mi_features = mutual_info_minimize_features(feature_table=feature_table)
