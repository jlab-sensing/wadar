function PlotTripleTag(captureFT, tag1FT, tag2FT, tag3FT, tag1Name, tag2Name, tag3Name, frameRate)
% PlotTripleTag(captureFT, tag1FT, tag2FT, tag3FT, tag1Name, tag2Name, tag3Name, frameRate)
%
...
plot(tag2FT)
plot(tag3FT)
legend([string(tag1Name), string(tag2Name), string(tag3Name)])
xlabel('Range Bins')
ylabel('Magnitude')
