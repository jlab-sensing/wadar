...
% matching algorithm derived in by Du et al.
% https://academic.oup.com/bioinformatics/article/22/17/2059/274284.
% The algorithm has been adapted to work in MATLAB and is used to find the
% peak bin of the tag signal in the radar data capture. This is a Stage 3 processing
% function.
%
% Inputs:
%   tagFT: FFT of the tag signal.
%   displayPlot: Boolean to display plots. Useful for tuning the control variables.
%
% Outputs:
