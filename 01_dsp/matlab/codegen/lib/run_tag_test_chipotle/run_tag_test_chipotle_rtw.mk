###########################################################################
## Makefile generated for component 'run_tag_test_chipotle'. 
## 
## Makefile     : run_tag_test_chipotle_rtw.mk
## Generated on : Thu Mar 27 00:17:27 2025
## Final product: ./run_tag_test_chipotle.lib
...
PRODUCT_NAME              = run_tag_test_chipotle
MAKEFILE                  = run_tag_test_chipotle_rtw.mk
MATLAB_ROOT               = .
MATLAB_BIN                = .
MATLAB_ARCH_BIN           = .
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = run_tag_test_chipotle.lib
...
PRODUCT = ./run_tag_test_chipotle.lib
...
DEFINES_STANDARD = -DMODEL=run_tag_test_chipotle
...
SRCS = coder_fileops.c coder_platform.c run_tag_test_chipotle_data.c rt_nonfinite.c rtGetNaN.c rtGetInf.c run_tag_test_chipotle_initialize.c run_tag_test_chipotle_terminate.c run_tag_test_chipotle.c pwd1.c strcat.c fullfile.c hasIRIPrefix.c fileManager.c fread.c coderFread.c ifWhileCond.c mrdivide_helper.c mtimes.c minOrMax.c NoveldaChipParams.c string1.c NoveldaDDC.c linspace.c mean.c conv.c fft.c FFTImplementationCallback.c abs.c findpeaks.c eml_setop.c norm.c colon.c strcmp.c sin.c cos.c smoothdata.c circshift.c round.c proc_frames.c run_tag_test_chipotle_emxutil.c
...
OBJS = coder_fileops.c.o coder_platform.c.o run_tag_test_chipotle_data.c.o rt_nonfinite.c.o rtGetNaN.c.o rtGetInf.c.o run_tag_test_chipotle_initialize.c.o run_tag_test_chipotle_terminate.c.o run_tag_test_chipotle.c.o pwd1.c.o strcat.c.o fullfile.c.o hasIRIPrefix.c.o fileManager.c.o fread.c.o coderFread.c.o ifWhileCond.c.o mrdivide_helper.c.o mtimes.c.o minOrMax.c.o NoveldaChipParams.c.o string1.c.o NoveldaDDC.c.o linspace.c.o mean.c.o conv.c.o fft.c.o FFTImplementationCallback.c.o abs.c.o findpeaks.c.o eml_setop.c.o norm.c.o colon.c.o strcmp.c.o sin.c.o cos.c.o smoothdata.c.o circshift.c.o round.c.o proc_frames.c.o run_tag_test_chipotle_emxutil.c.o
...
run_tag_test_chipotle_data.c.o : run_tag_test_chipotle_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
run_tag_test_chipotle_initialize.c.o : run_tag_test_chipotle_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


run_tag_test_chipotle_terminate.c.o : run_tag_test_chipotle_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


run_tag_test_chipotle.c.o : run_tag_test_chipotle.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
proc_frames.c.o : proc_frames.c
	$(CC) $(CFLAGS) -o "$@" "$<"


run_tag_test_chipotle_emxutil.c.o : run_tag_test_chipotle_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"
