...
enum opt_code
{
  ...
  OPT_mandroid = 1957,                       /* -mandroid */
  OPT_mapcs = 1958,                          /* -mapcs */
  OPT_mapcs_frame = 1959,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1960,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1961,              /* -mapcs-stack-check */
  OPT_march_ = 1962,                         /* -march= */
  OPT_marm = 1963,                           /* -marm */
  OPT_masm_syntax_unified = 1964,            /* -masm-syntax-unified */
  OPT_mbe32 = 1965,                          /* -mbe32 */
  OPT_mbe8 = 1966,                           /* -mbe8 */
  OPT_mbig_endian = 1967,                    /* -mbig-endian */
  OPT_mbionic = 1968,                        /* -mbionic */
  OPT_mbranch_cost_ = 1969,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1970,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1971,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1972,     /* -mcaller-super-interworking */
  OPT_mcmse = 1973,                          /* -mcmse */
  OPT_mcpu_ = 1974,                          /* -mcpu= */
  OPT_mdlstp = 1975,                         /* -mdlstp */
  OPT_mfdpic = 1976,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1977,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1978,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1979, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1980,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1981,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1982,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1983,                  /* -mfp16-format= */
  OPT_mfpu_ = 1984,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1985,             /* -mgeneral-regs-only */
  OPT_mglibc = 1986,                         /* -mglibc */
  /* OPT_mhard_float = 1987, */              /* -mhard-float */
  OPT_mlibarch_ = 1988,                      /* -mlibarch= */
  OPT_mlittle_endian = 1989,                 /* -mlittle-endian */
  OPT_mlong_calls = 1990,                    /* -mlong-calls */
  OPT_mmusl = 1991,                          /* -mmusl */
  OPT_mneon_for_64bits = 1992,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1993,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1994,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1995,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1996,               /* -mprint-tune-info */
  OPT_mpure_code = 1997,                     /* -mpure-code */
  OPT_mrestrict_it = 1998,                   /* -mrestrict-it */
  OPT_msched_prolog = 1999,                  /* -msched-prolog */
  OPT_msingle_pic_base = 2000,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 2001,               /* -mslow-flash-data */
  /* OPT_msoft_float = 2002, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 2003, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2004,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2005,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2006,                         /* -mthumb */
  OPT_mthumb_interwork = 2007,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2008,                  /* -mtls-dialect= */
  OPT_mtp_ = 2009,                           /* -mtp= */
  OPT_mtpcs_frame = 2010,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2011,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2012,                         /* -mtune= */
  OPT_muclibc = 2013,                        /* -muclibc */
  OPT_munaligned_access = 2014,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 2015,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 2016,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 2017,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 2018,              /* -mword-relocations */
  OPT_n = 2019,                              /* -n */
  OPT_name_sort = 2020,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2021,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2022,              /* -no-integrated-cpp */
  OPT_no_pie = 2023,                         /* -no-pie */
  OPT_nocpp = 2024,                          /* -nocpp */
  OPT_nodefaultlibs = 2025,                  /* -nodefaultlibs */
  OPT_nolibc = 2026,                         /* -nolibc */
  OPT_nophoboslib = 2027,                    /* -nophoboslib */
  OPT_nostartfiles = 2028,                   /* -nostartfiles */
  OPT_nostdinc = 2029,                       /* -nostdinc */
  OPT_nostdinc__ = 2030,                     /* -nostdinc++ */
  OPT_nostdlib = 2031,                       /* -nostdlib */
  OPT_nostdlib__ = 2032,                     /* -nostdlib++ */
  OPT_o = 2033,                              /* -o */
  OPT_objects = 2034,                        /* -objects */
  OPT_p = 2035,                              /* -p */
  OPT_pass_exit_codes = 2036,                /* -pass-exit-codes */
  /* OPT_pedantic = 2037, */                 /* -pedantic */
  OPT_pedantic_errors = 2038,                /* -pedantic-errors */
  OPT_pg = 2039,                             /* -pg */
  OPT_pie = 2040,                            /* -pie */
  OPT_pipe = 2041,                           /* -pipe */
  OPT_posix = 2042,                          /* -posix */
  ...
  OPT_profile = 2055,                        /* -profile */
  OPT_pthread = 2056,                        /* -pthread */
  OPT_quiet = 2057,                          /* -quiet */
  OPT_r = 2058,                              /* -r */
  OPT_rdynamic = 2059,                       /* -rdynamic */
  OPT_remap = 2060,                          /* -remap */
  OPT_reverse_sort = 2061,                   /* -reverse-sort */
  OPT_s = 2062,                              /* -s */
  OPT_save_temps = 2063,                     /* -save-temps */
  OPT_save_temps_ = 2064,                    /* -save-temps= */
  OPT_shared = 2065,                         /* -shared */
  OPT_shared_libgcc = 2066,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2067,               /* -shared-libphobos */
  OPT_size_sort = 2068,                      /* -size-sort */
  /* OPT_specs = 2069, */                    /* -specs */
  OPT_specs_ = 2070,                         /* -specs= */
  OPT_static = 2071,                         /* -static */
  OPT_static_libasan = 2072,                 /* -static-libasan */
  OPT_static_libgcc = 2073,                  /* -static-libgcc */
  OPT_static_libgfortran = 2074,             /* -static-libgfortran */
  OPT_static_libgm2 = 2075,                  /* -static-libgm2 */
  OPT_static_libgo = 2076,                   /* -static-libgo */
  OPT_static_libhwasan = 2077,               /* -static-libhwasan */
  OPT_static_liblsan = 2078,                 /* -static-liblsan */
  OPT_static_libmpx = 2079,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2080,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2081,               /* -static-libphobos */
  OPT_static_libquadmath = 2082,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2083,               /* -static-libstdc++ */
  OPT_static_libtsan = 2084,                 /* -static-libtsan */
  OPT_static_libubsan = 2085,                /* -static-libubsan */
  OPT_static_pie = 2086,                     /* -static-pie */
  /* OPT_std_c__03 = 2087, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2088, */                /* -std=c++0x */
  OPT_std_c__11 = 2089,                      /* -std=c++11 */
  OPT_std_c__14 = 2090,                      /* -std=c++14 */
  OPT_std_c__17 = 2091,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2092, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2093, */                /* -std=c++1z */
  OPT_std_c__20 = 2094,                      /* -std=c++20 */
  OPT_std_c__23 = 2095,                      /* -std=c++23 */
  OPT_std_c__26 = 2096,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2097, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2098, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2099, */                /* -std=c++2c */
  OPT_std_c__98 = 2100,                      /* -std=c++98 */
  OPT_std_c11 = 2101,                        /* -std=c11 */
  OPT_std_c17 = 2102,                        /* -std=c17 */
  /* OPT_std_c18 = 2103, */                  /* -std=c18 */
  /* OPT_std_c1x = 2104, */                  /* -std=c1x */
  OPT_std_c23 = 2105,                        /* -std=c23 */
  /* OPT_std_c2x = 2106, */                  /* -std=c2x */
  /* OPT_std_c89 = 2107, */                  /* -std=c89 */
  OPT_std_c90 = 2108,                        /* -std=c90 */
  OPT_std_c99 = 2109,                        /* -std=c99 */
  /* OPT_std_c9x = 2110, */                  /* -std=c9x */
  OPT_std_f2003 = 2111,                      /* -std=f2003 */
  OPT_std_f2008 = 2112,                      /* -std=f2008 */
  OPT_std_f2008ts = 2113,                    /* -std=f2008ts */
  OPT_std_f2018 = 2114,                      /* -std=f2018 */
  OPT_std_f2023 = 2115,                      /* -std=f2023 */
  OPT_std_f95 = 2116,                        /* -std=f95 */
  OPT_std_gnu = 2117,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2118, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2119, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2120,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2121,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2122,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2123, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2124, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2125,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2126,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2127,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2128, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2129, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2130, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2131,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2132,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2133,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2134, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2135, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2136,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2137, */                /* -std=gnu2x */
  /* OPT_std_gnu89 = 2138, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2139,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2140,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2141, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2142, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2143,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2144, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2145, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2146, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2147, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2148, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2149, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2150,                     /* -std=legacy */
  OPT_stdlib_ = 2151,                        /* -stdlib= */
  OPT_symbol_ = 2152,                        /* -symbol= */
  OPT_symbolic = 2153,                       /* -symbolic */
  OPT_t = 2154,                              /* -t */
  OPT_time = 2155,                           /* -time */
  OPT_time_ = 2156,                          /* -time= */
  OPT_tno_android_cc = 2157,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2158,                 /* -tno-android-ld */
  OPT_traditional = 2159,                    /* -traditional */
  OPT_traditional_cpp = 2160,                /* -traditional-cpp */
  OPT_tree_stats = 2161,                     /* -tree-stats */
  OPT_trigraphs = 2162,                      /* -trigraphs */
  OPT_type_stats = 2163,                     /* -type-stats */
  OPT_u = 2164,                              /* -u */
  OPT_undef = 2165,                          /* -undef */
  OPT_v = 2166,                              /* -v */
  OPT_version = 2167,                        /* -version */
  OPT_w = 2168,                              /* -w */
  OPT_wrapper = 2169,                        /* -wrapper */
  OPT_x = 2170,                              /* -x */
  OPT_z = 2171,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
