...
static const _TagRelativeLocation_type_support_symbol_names_t _TagRelativeLocation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wadar_interfaces, msg, TagRelativeLocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wadar_interfaces, msg, TagRelativeLocation)),
  }
};
...
{
  return &::wadar_interfaces::msg::rosidl_typesupport_cpp::TagRelativeLocation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wadar_interfaces, msg, TagRelativeLocation)() {
  return get_message_type_support_handle<wadar_interfaces::msg::TagRelativeLocation>();
}
