...
#include "inertial_sense_ros2/srv/detail/firmware_update__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const inertial_sense_ros2::srv::FirmwareUpdate_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  inertial_sense_ros2::srv::FirmwareUpdate_Request & ros_message)
{
  // Member: filename
  cdr >> ros_message.filename;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = inertial_sense_ros2::srv::FirmwareUpdate_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inertial_sense_ros2::srv::FirmwareUpdate_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inertial_sense_ros2::srv::FirmwareUpdate_Request *>(
    untyped_ros_message);
...
static size_t _FirmwareUpdate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FirmwareUpdate_Request(full_bounded, is_plain, 0);
...
{
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inertial_sense_ros2, srv, FirmwareUpdate_Request)() {
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_inertial_sense_ros2
cdr_serialize(
  const inertial_sense_ros2::srv::FirmwareUpdate_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  inertial_sense_ros2::srv::FirmwareUpdate_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = inertial_sense_ros2::srv::FirmwareUpdate_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inertial_sense_ros2::srv::FirmwareUpdate_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<inertial_sense_ros2::srv::FirmwareUpdate_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _FirmwareUpdate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FirmwareUpdate_Response(full_bounded, is_plain, 0);
...
{
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inertial_sense_ros2, srv, FirmwareUpdate_Response)() {
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Response__handle;
}
...
// functions for inertial_sense_ros2::srv::FirmwareUpdate_Request already declared above

// functions for inertial_sense_ros2::srv::FirmwareUpdate_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_inertial_sense_ros2
cdr_serialize(
  const inertial_sense_ros2::srv::FirmwareUpdate_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  inertial_sense_ros2::srv::FirmwareUpdate_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_inertial_sense_ros2
max_serialized_size_FirmwareUpdate_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        inertial_sense_ros2::srv::typesupport_fastrtps_cpp::max_serialized_size_FirmwareUpdate_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        inertial_sense_ros2::srv::typesupport_fastrtps_cpp::max_serialized_size_FirmwareUpdate_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = inertial_sense_ros2::srv::FirmwareUpdate_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inertial_sense_ros2::srv::FirmwareUpdate_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<inertial_sense_ros2::srv::FirmwareUpdate_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FirmwareUpdate_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const inertial_sense_ros2::srv::FirmwareUpdate_Event *>(
...
static size_t _FirmwareUpdate_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FirmwareUpdate_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FirmwareUpdate_Event__callbacks = {
  "inertial_sense_ros2::srv",
...
static rosidl_message_type_support_t _FirmwareUpdate_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FirmwareUpdate_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inertial_sense_ros2, srv, FirmwareUpdate_Event)() {
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Event__handle;
}
...
static const rosidl_service_type_support_t _FirmwareUpdate__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FirmwareUpdate__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<inertial_sense_ros2::srv::FirmwareUpdate_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<inertial_sense_ros2::srv::FirmwareUpdate_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<inertial_sense_ros2::srv::FirmwareUpdate_Event>(),
...
{
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inertial_sense_ros2, srv, FirmwareUpdate)() {
  return &inertial_sense_ros2::srv::typesupport_fastrtps_cpp::_FirmwareUpdate__handle;
}
