...
#include "inertial_sense_ros2/msg/detail/gps_info__rosidl_typesupport_fastrtps_c.h"
...
#include "inertial_sense_ros2/msg/detail/sat_info__functions.h"  // sattelite_info
...
using _GPSInfo__ros_msg_type = inertial_sense_ros2__msg__GPSInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: sattelite_info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, inertial_sense_ros2, msg, SatInfo
      )()->data);
    size_t size = 50;
    auto array_ptr = ros_message->sattelite_info;
  ...
  void * untyped_ros_message)
{
  ...
  _GPSInfo__ros_msg_type * ros_message = static_cast<_GPSInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  // field.name sattelite_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_inertial_sense_ros2__msg__SatInfo(
...
static uint32_t _GPSInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_inertial_sense_ros2__msg__GPSInfo(
  ...
  size_t current_alignment)
{
  ...
  // member: sattelite_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_inertial_sense_ros2__msg__SatInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = inertial_sense_ros2__msg__GPSInfo;
    is_plain =
      (
      offsetof(DataType, sattelite_info) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GPSInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_inertial_sense_ros2__msg__GPSInfo(
