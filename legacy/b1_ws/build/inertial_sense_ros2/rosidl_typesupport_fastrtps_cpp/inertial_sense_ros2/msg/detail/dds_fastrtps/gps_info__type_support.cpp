...
#include "inertial_sense_ros2/msg/detail/gps_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const inertial_sense_ros2::msg::SatInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  // Member: sattelite_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.sattelite_info[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: sattelite_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        inertial_sense_ros2::msg::typesupport_fastrtps_cpp::max_serialized_size_SatInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = inertial_sense_ros2::msg::GPSInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const inertial_sense_ros2::msg::GPSInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inertial_sense_ros2::msg::GPSInfo *>(
    untyped_ros_message);
...
{
  return &inertial_sense_ros2::msg::typesupport_fastrtps_cpp::_GPSInfo__handle;
}
