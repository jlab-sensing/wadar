...
airBins = 199; % number of bins from the radar to the un-burried tag
airSoilBins = 229; % number of bins from the radar to the burried tag
RAW = 2483;  %RAW teros12 measurement
d=0.05; %meters
