function VWC = procSoilMoisture(wetPeakBin, airPeakBin, soilType, distance)
% VWC = procSoilMoisture(wetPeakBin, airPeakBin, soilType, distance)
%
% Function calculates VWC from ToF and teros-12 sensor measurements
%
% Inputs:
